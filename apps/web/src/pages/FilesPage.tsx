...
export function FilesPage() {
  ...
  return (
    <>
      <PageHeader title="Files" sub={`${files.length} stored — attach or share`}>
                ...
                return (
                  <li key={f.id} className="files-item">
                    ...
                    <button
                      ...
                      aria-label={f.shareToken ? "Copy public link" : "Create public link"}
                      title={f.shareToken ? "Shared — copies the link" : "Create a public link"}
